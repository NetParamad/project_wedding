...
<div class="container py-5">
    <h1 class="fw-bold mb-4 text-center" style="color: var(--primary-dark);"><?php echo $pageTitle; ?></h1>
    
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
                <div class="card-body p-4">
                    <h3 class="fw-bold mb-3" style="color: var(--primary-dark);">🏪 <?php echo htmlspecialchars($shop_name); ?></h3>
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
                <div class="card-body p-4">
                    <h4 class="fw-bold mb-3" style="color: var(--primary-dark);">📋 บริการของเรา</h4>
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
                <div class="card-body p-4">
                    <h4 class="fw-bold mb-3" style="color: var(--primary-dark);">📞 ติดต่อเรา</h4>
                    <ul class="list-unstyled">
                        <?php if ($shop_phone): ?>
                        ...
                        <?php endif; ?>
                        <li class="mb-2">
                            <a href="https://m.me/ChinKornMakeUp" target="_blank" class="btn btn-pink">
                                💬 Messenger
                            </a>
                        </li>
                    </ul>
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 20px;">
                <div class="card-body p-4">
                    <h4 class="fw-bold mb-3" style="color: var(--primary-dark);">💳 ชำระเงินผ่าน Prompay</h4>
            ...
            <div class="text-center">
                <a href="products.php" class="btn btn-pink btn-lg">เลือกชุดและสินค้า</a>
            </div>
        </div>
    </div>
</div>
