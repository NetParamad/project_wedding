...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
    <div class="container">
        <a class="navbar-brand font-elegant" href="../index.php">
                ...
                <?php if ($is_login): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="../pages/cart.php">
                            ...
                            <?php if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0): ?>
                                <span class="badge ms-1" style="background: var(--gold); color: white;"><?php echo count($_SESSION['cart']); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <?php if ($is_admin): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="../admin/dashboard.php" style="color: var(--gold); font-weight: 600;">
                                แผนควบคุม
                            </a>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="../pages/profile.php"><i class="bi bi-person me-2"></i>โปรไฟล์</a></li>
